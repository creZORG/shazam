...
export const metadata: Metadata = {
  title: "About Mov33 | The Heart of Kenya's Entertainment",
  description: "Learn about Mov33's mission to connect people with unforgettable experiences, from concerts and tours to vibrant nightlife.",
};
      ...
      <Card className="max-w-4xl mx-auto">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-lg text-muted-foreground mt-2">
            The heart of culture and entertainment.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6 text-base text-muted-foreground leading-relaxed">
          <p>
            Mov33 is a vibrant platform dedicated to showcasing the best of what the entertainment scene has to offer. Our mission is to connect people with unforgettable experiences, from sold-out concerts and thrilling tours to the hottest nightlife spots.
          </p>
          <p>
          ...
          <div className="p-6 bg-secondary/50 rounded-lg text-center">
            ...
            <p className="mt-2">
              We are a passionate team of developers, designers, and event enthusiasts dedicated to building the ultimate platform for the entertainment scene.
            </p>
